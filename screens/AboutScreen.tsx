...
const styles = StyleSheet.create({
  ...
  storyCard: {
    backgroundColor: COLORS.card, borderRadius: RADIUS.xl, padding: SPACING.xl, ...SHADOWS.md, marginBottom: SPACING.xl,
  },
  ...
  teamCard: { backgroundColor: COLORS.card, borderRadius: RADIUS.xl, padding: SPACING.xl, ...SHADOWS.md },
